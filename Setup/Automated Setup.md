...
Refer to this Automated Deployment Process [walk-through video](https://youtu.be/Pd62rhF6Cy0) for an overview of the process before you start. After this deployment process please refer to [walk-through video](https://youtu.be/Pd62rhF6Cy0) to configure the system or see the Getting Start guide. 
